 ...
 * @param value$0 Первое значение.
 * @param value$1 Второе значение.
 * @return Минимум из @p value$0 и @p value$1.
 */
#if !defined(MIN) || defined(DOXYGEN)
   #define MIN(value$0, value$1) (                                                                                     \
      {                                                                                                                \
         __auto_type $$value$0 = (value$0);                                                                            \
 ...
 * @param value$0 Первое значение.
 * @param value$1 Второе значение.
 * @return Максимум из @p value$0 и @p value$1.
 */
#if !defined(MAX) || defined(DOXYGEN)
   #define MAX(value$0, value$1) (                                                                                     \
      {                                                                                                                \
         __auto_type $$value$0 = (value$0);                                                                            \
         __auto_type $$value$1 = (value$1);                                                                            \
         ($$value$0 > $$value$1) ? $$value$0 : $$value$1;                                                              \
 ...
 * @param value$0 Первое значение.
 * @param value$1 Второе значение.
 * @return `true`, если операция @p value$0 + @p value$1 вызовет переполнение, иначе - `false`.
 */
#if !defined(WILL_INT_ADD_OVERFLOW) || defined(DOXYGEN)
   #define WILL_INT_ADD_OVERFLOW(value$0, value$1)                                                                     \
      __builtin_add_overflow_p(value$0, value$1, (typeof((value$0) + (value$1)))0)
#endif

/**
 * @brief Проверяет, вызовет ли целочисленное вычитание переполнение.
 * @param value$0 Уменьшаемое.
 * @param value$1 Вычитаемое.
 * @return `true`, если операция @p value$0 - @p value$1 вызовет переполнение, иначе - `false`.
 */
#if !defined(WILL_INT_SUB_OVERFLOW) || defined(DOXYGEN)
   #define WILL_INT_SUB_OVERFLOW(value$0, value$1)                                                                     \
      __builtin_sub_overflow_p(value$0, value$1, (typeof((value$0) - (value$1)))0)
#endif
 ...
 */
   ...
   #define WILL_INT_MUL_OVERFLOW(value$0, value$1)                                                                     \
      __builtin_mul_overflow_p(value$0, value$1, (typeof((value$0) * (value$1)))0)
#endif
 ...
 * @param value$0 Первое значение.
 * @param value$1 Второе значение.
 * @param result Результат исполнения операции @p value$0 + @p value$1.
 * @return `true`, если операция @p value$0 + @p value$1 не вызвала переполнения, иначе - `false`.
 */
#if !defined(TRY_ADD_INT_CHECKED) || defined(DOXYGEN)
   #define TRY_ADD_INT_CHECKED(value$0, value$1, result) (!__builtin_add_overflow(value$0, value$1, result))
#endif
 ...
 */
   ...
   #define TRY_SUB_INT_CHECKED(value$0, value$1, result) (!__builtin_sub_overflow(value$0, value$1, result))
#endif
 ...
 */
   ...
   #define TRY_MUL_INT_CHECKED(value$0, value$1, result) (!__builtin_mul_overflow(value$0, value$1, result))
#endif
 ...
 * @return Результат исполнения операции ⌈ @p value$0 / @p value$1 ⌉.
 */
